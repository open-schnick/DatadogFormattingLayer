...
mod simple_layer {
    ...
    use smoothy::{assert_that, EqualityAssertion, IteratorAssertion, StringAssertion};
    use tracing::info;
...
mod layer_with_otel {
    ...
    use smoothy::{assert_that, EqualityAssertion, IteratorAssertion, OptionAssertion};
    use tracing::info;
...
mod setup {
    ...
    use smoothy::{BasicAsserter, EqualityAssertion, OptionAssertion};
